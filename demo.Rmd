...
## Calculating complexity of gene biotypes

Complexity tells the number of unique gene IDs per biotype.


```{r calculate_complexity, results='asis'}
...
print(knitr::kable(head(cleaned.df)))
```

## Plotting complexity of gene biotypes


```{r plot_complexity, results='asis', fig.width=8, fig.height=6}
